...
function TableRow({dataID, from, to, date, guests, flightClass }) {
    ...
    return (
        <tr className="lws-bookedTable text-black" key={dataID}>
            ...
            <td className="px-6 py-4 text-center">
                <div className="flex justify-center gap-4">
                    <button className="lws-remove" onClick={() => cancelBookingHandler(dataID)}>
